      ...
      <div class="bg-gray-100 text-TextColor w-full ">
        <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col bg-BgColor">
          <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            ...
            <span class="ml-3 text-lg text-TextColor">Dr. fixit Waterproofing Solutions</span>
          </a>
          <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2025 Dr. fixit Waterproofing Solutions —
            <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">@Anil kumar</a>
          </p>
